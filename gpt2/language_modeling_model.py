...
class LanguageModelingModel:
    ...
    def train(
        ...
        if global_step == 0:
            print("WARNING: global_step == 0")
            result2 = 0
        else:
            result2 = tr_loss / global_step if not self.args.evaluate_during_training else training_progress_scores
        return (global_step, result2)
